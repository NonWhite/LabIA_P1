...
\ShortHeadings{Experimentando com Max-SAT Solvers}{Walter Perez Urcia}
\firstpageno{1}

\begin{document}

\title{Experimentando com Max-SAT Solvers}

\author{\name Walter Perez Urcia \email wperez@ime.usp.br \\
       \addr Instituto de Matem\i{a}tica e Estad\u{i}stica\\
